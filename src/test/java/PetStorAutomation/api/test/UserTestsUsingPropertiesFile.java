...
import PetStorAutomation.api.endpoints.UserEndPointsFromPropertiesFile;
...
public class UserTestsUsingPropertiesFile {
    ...
    public void testUpdateUser()
    {
        ...
        Response response = UserEndPointsFromPropertiesFile.updateUser(userPayload,this.userPayload.getUsername());
        Assert.assertEquals(response.getStatusCode(),200);
